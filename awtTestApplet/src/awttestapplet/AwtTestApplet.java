 ...
 * @author Павел
 */
public class AwtTestApplet extends Applet
{
    ...
    public AwtTestApplet()
    {
        ...
        f_selectPanel1.add(new Label("Точка касания:"));
        f_tangent=new TextField("1", 8);
    ...
    {
        AwtTestApplet _test=new AwtTestApplet();
